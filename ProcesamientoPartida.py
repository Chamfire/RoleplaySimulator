...
class ProcesamientoPartida:
    ...
    def prepararPartida(self):
        ...
        #Creo el mapa 
        Mapa = Map_generation.Map_generation(self.ubicacion,self.currentPartida,tipo_mision,variableDeCheck,self.numJugadores,NPC_animacion) #que genere el mapa de una mazmorra
